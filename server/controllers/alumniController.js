...
const loginAlumni = async (req, res) => {
    ...
    try {
        ...
        res.cookie("token", token, cookieOptions).status(200).json({ username: alumni.username, token , role});
    } catch (error) {
        console.error(error);
...
module.exports = {signupAlumni,  loginAlumni, dashboardAlumni, requestSignup, removeAlumni};
